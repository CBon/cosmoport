...
<br>
    ...
    <form style="background-color: #E9ECEF; padding: 20px; border-radius: 10px; display: none" id="createButton">
        ...
        <div class="form-row">
            <div class="form-group col-md-3">
                <label for="inputShipTypeNew">Ship type</label>
        ...
        <div class="form-row">
            <div class="form-group col-md-6" style="padding: 0 10px">
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="inlineRadioNew1">Pre-owned</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadioNew2"
                           value="false">
                    <label class="form-check-label" for="inlineRadioNew2">New</label>
                </div>
            </div>
        </div>
    ...
    <form style="background-color: #E9ECEF; padding: 20px; border-radius: 10px">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-3" style="padding: 0 10px">
                <label for="inputProdYearAfter">Prod year between</label>
                <div class="form-row">
                    <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-3" style="padding: 0 10px">
                <label for="inputCrewSizeMin">Crew size between</label>
                <div class="form-row">
                    <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-3" style="padding: 0 10px">
                <label for="inputSpeedMin">Max speed between</label>
                <div class="form-row">
                    <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-3" style="padding: 0 10px">
                <label for="inputRatingMin">Rating between</label>
                <div class="form-row">
                    <div class="form-group col-md-6">
